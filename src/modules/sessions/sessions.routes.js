...
router.put('/:id/cancel', authorize('SUPER_ADMIN', 'MANAGER', 'CASHIER', 'STAFF'), controller.cancelSession);
router.put('/:id/transfer-room', authorize('SUPER_ADMIN', 'MANAGER', 'CASHIER', 'STAFF'), controller.transferRoom);
